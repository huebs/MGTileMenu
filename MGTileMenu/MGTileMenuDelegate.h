...
- (UIImage *)imageForTile:(NSInteger)tileNumber
				   inMenu:(MGTileMenuController *)tileMenu;				// zero-based tileNumber
...
#pragma mark - Tile backgrounds.

@optional

- (UIImage *)backgroundImageForTile:(NSInteger)tileNumber
							 inMenu:(MGTileMenuController *)tileMenu;	// zero-based tileNumber
- (CGGradientRef)gradientForTile:(NSInteger)tileNumber
						  inMenu:(MGTileMenuController *)tileMenu;		// zero-based tileNumber
- (UIColor *)colorForTile:(NSInteger)tileNumber
				   inMenu:(MGTileMenuController *)tileMenu;				// zero-based tileNumber
...
#pragma mark - Interaction/Notification

@required

- (void)tileMenu:(MGTileMenuController *)tileMenu
 didActivateTile:(NSInteger)tileNumber;									// zero-based tileNumber
...
- (void)tileMenu:(MGTileMenuController *)tileMenu
   didSelectTile:(NSInteger)tileNumber;									// zero-based tileNumber
- (void)tileMenu:(MGTileMenuController *)tileMenu
 didDeselectTile:(NSInteger)tileNumber;									// zero-based tileNumber

- (BOOL)tileMenu:(MGTileMenuController *)tileMenu
	shouldSwitchToPage:(NSInteger)pageNumber;							// zero-based pageNumber
- (void)tileMenu:(MGTileMenuController *)tileMenu
willSwitchToPage:(NSInteger)pageNumber;									// zero-based pageNumber
- (void)tileMenu:(MGTileMenuController *)tileMenu
 didSwitchToPage:(NSInteger)pageNumber;									// zero-based pageNumber
